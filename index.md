...
address: "	Tennent Drive, Palmerston North, New Zealand"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-40.386070,175.616320"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Aug 26-27, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
This is a workshop for Massey University Library Staff.
{% endcomment %}
{% if page.carpentry == "swc" %}
{% include sc/who.html %}
{% elsif page.carpentry == "dc" %}
...
http://pad.carpentries.org/2019-08-26-massey
